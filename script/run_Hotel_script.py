...
# project_path = os.path.join(script_dir, '..', 'hotel')
project_path = os.path.join(script_dir, '..')

sys.path.append(project_path)

# 导入爬虫类
from hotel.hotel.spiders.ctrip import HotelSpider
from hotel.hotel.pipelines import JsonWriterPipeline


        
def GetHotelData(queue):
    """
    ...
    process.settings.set("ITEM_PIPELINES", {
        "hotel.hotel.pipelines.JsonWriterPipeline": 1,  # 使用当前脚本中的 Pipeline
    })
